...
public class ClientService extends IntentService {
    ...
    public ClientService(Handler mHandlerInput) {
        super("ClientService");
    ...
    protected void onHandleIntent(Intent intent) {
        try{
            String macAddr=intent.getStringExtra("macAddr");
            String uri="";
            //uri=intent.getStringExtra("uri");
            Log.d("ClientService","MacAdddr  of the server to be connected is:"+macAddr);
            ...
            newConnectThread.uri= Uri.parse(uri);
            newConnectThread.start();

        }
        catch(Exception e)
        {
            Log.d("Client Service","Exception occured:"+e);
